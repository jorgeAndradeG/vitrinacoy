    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="{{action('App\Http\Controllers\ProductosController@edit', $producto->id)}}" type="button"
                ...
                <td><a type="button" class="btn btn-danger btn-sm ventana" data-bs-toggle="modal"
                        data-bs-target="#exampleModal" data-id='{{$producto->id}}'> <i class="far fa-trash-alt"
